...
> **v1.2.2.** Nobody outside this repository has reviewed the code, and key generation on the
...
src/links.js                every address the app may hand to the browser — the only file with one
...
test/guarantees.test.js     no network, no shell strings, no stray addresses, isolation intact
